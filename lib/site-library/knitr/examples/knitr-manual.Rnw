...
<<<<<<< HEAD
## tune details of base graphics (https://yihui.name/knitr/hooks)
=======
...
<<<<<<< HEAD
the package homepage \url{https://yihui.name/knitr/}.
=======
...
<<<<<<< HEAD
first: \url{https://yihui.name/knitr/demo/sweave/}.
=======
...
<<<<<<< HEAD
appropriate set of \href{https://yihui.name/knitr/patterns}{patterns}
to use if they are not provided in advance (e.g. \textsf{file.Rnw}
will use \texttt{knit\_patterns\$get('rnw')});
\item a set of output \href{https://yihui.name/knitr/hooks}{hooks} will
=======
...
<<<<<<< HEAD
\href{https://yihui.name/knitr/options}{option}) and any one of these
=======
...
<<<<<<< HEAD
dedicated to specific features such as graphics in the website: \url{https://yihui.name/knitr/demos}.
=======
...
<<<<<<< HEAD
check it out in the \href{https://yihui.name/knitr/demo/graphics/}{website}.
=======
...
<<<<<<< HEAD
See \url{https://yihui.name/knitr/demo/cache/} for examples.
=======
...
<<<<<<< HEAD
character strings. The page \url{https://yihui.name/knitr/demo/sweave/}
=======
...
<<<<<<< HEAD
These are simply character string operations. Many demos in \url{https://yihui.name/knitr/demos}
=======
...
possible to support other editors like \href{https://yihui.name/knitr/demo/eclipse/}{Eclipse},
\href{https://yihui.name/knitr/demo/editors/}{Texmaker and WinEdt};
=======
